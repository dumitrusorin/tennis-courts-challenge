...
insert
    into
        ...
        (id, start_date_time, end_date_time, tennis_court_id)
    values
        (null, '2020-12-20T19:00:00.0', '2020-02-20T20:00:00.0', 1);
insert
    into
        schedule
        (id, start_date_time, end_date_time, tennis_court_id)
    values
        (null, '2020-12-20T18:00:00.0', '2020-02-20T19:00:00.0', 2);
insert
    into
        schedule
        (id, start_date_time, end_date_time, tennis_court_id)
...
insert
    into
        ...
        (id, start_date_time, end_date_time, tennis_court_id)
    values
        (null, '2020-12-20T20:00:00.0', '2020-02-20T21:00:00.0', 2);